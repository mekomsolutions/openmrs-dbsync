...
public class RelationshipExtractTest extends OpenmrsExtractEndpointITest<Relationship, RelationshipModel> {
	...
	private String getExpectedJson() {
		return "{\"tableToSyncModelClass\":\"" + RelationshipModel.class.getName() + "\"," + "\"model\":{" + "\"uuid\":\""
		        ...
		        + "\"dateCreated\":\"2021-06-22T00:00:00Z\"," + "\"changedByUuid\":null," + "\"dateChanged\":null,"
		        + "\"voided\":false," + "\"voidedByUuid\":null," + "\"dateVoided\":null," + "\"voidReason\":null,"
		        + "\"personaUuid\":\"" + PatientLight.class.getName() + "(ed279794-76e9-11e9-8cd9-0242ac1c000b)\","
		        + "\"personbUuid\":\"" + PersonLight.class.getName() + "(dd279794-76e9-11e9-8cd9-0242ac1c000b)\","
		        + "\"relationshipTypeUuid\":\"" + RelationshipTypeLight.class.getName()
		        + "(1d279794-76e9-11e9-8cd8-0242ac1c111e)\"," + "\"startDate\":\"2021-06-22T01:00:00Z\","
		        + "\"endDate\":\"2021-06-22T02:00:00Z\"}}";
	}
}
