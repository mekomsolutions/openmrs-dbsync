...
public class EncounterProviderExtractTest extends OpenmrsExtractEndpointITest<EncounterProvider, EncounterProviderModel> {
	...
	private String getExpectedJson() {
		return "{\"tableToSyncModelClass\":\"" + EncounterProviderModel.class.getName() + "\"," + "\"model\":{"
		        ...
		        + "(1a789794-31e9-11e9-8cf7-0242ac1c177f)\"}}";
	}
