...
public class OpenmrsExtractPersonAddressITest extends OpenmrsExtractEndpointITest {
	...
	public void extract() throws JSONException {
		// Given
		CamelInitObect camelInitObect = CamelInitObect.builder().tableToSync("PERSON_ADDRESS").lastSyncDate(date).build();
	...
	private String getExpectedJson() {
		return "{" + "\"tableToSyncModelClass\":\"" + PersonAddressModel.class.getName() + "\"," + "\"model\":{"
		        + "\"uuid\":\"uuid_person_address\"," + "\"creatorUuid\":\"" + UserLight.class.getName() + "(user_uuid)\","
