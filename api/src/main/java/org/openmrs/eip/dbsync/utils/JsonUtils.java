...
public final class JsonUtils {
	...
	public static boolean containsItemWithKeyEqualsValue(final String jsonArray, final String key, final String value) {
		...
		while (it.hasNext()) {
			if (value.equalsIgnoreCase(((JSONObject) it.next()).getString(key)))
				return true;
		}
		return false;
	}
	 ...
	 */
	public static String getPropertyValueWhereKeyMatchesValue(final String jsonArray, final String propertyName,
