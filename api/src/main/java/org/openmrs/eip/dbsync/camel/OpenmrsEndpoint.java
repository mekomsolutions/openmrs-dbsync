...
@UriEndpoint(firstVersion = "1.0.0", scheme = "openmrs", title = "OpenMRS", syntax = "openmrs:action", producerOnly = true)
public class OpenmrsEndpoint extends DefaultEndpoint {
	...
	public Producer createProducer() {
		...
		try {
			...
			throw new SyncException("Unable to initialize producer " + action.getProducerClass().getName(), e);
		}
	}
