...
public class OrderGroupLoadTest extends OpenmrsLoadEndpointITest<OrderGroup> {
	...
	private SyncModel getOrderGroupModel() {
		return JsonUtils.unmarshalSyncModel("{\"tableToSyncModelClass\":\"" + OrderGroupModel.class.getName() + "\","
		        ...
		        + "(1a379794-31e9-11e9-8cf7-0242ac1c177b)\"," + "\"reasonUuid\":null," + "\"parentUuid\":null,"
		        + "\"previousOrderGroupUuid\":null}, \"metadata\":{\"operation\":\"c\"}}");
	}
}
