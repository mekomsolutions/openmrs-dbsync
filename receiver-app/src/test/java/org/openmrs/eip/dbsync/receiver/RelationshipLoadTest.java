...
public class RelationshipLoadTest extends OpenmrsLoadEndpointITest<Relationship> {
	...
	private SyncModel getRelationshipModel() {
		return JsonUtils.unmarshalSyncModel("{\"tableToSyncModelClass\":\"" + RelationshipModel.class.getName() + "\","
		        ...
		        + "\"voidReason\":null," + "\"personaUuid\":\"" + PersonLight.class.getName()
		        + "(dd279794-76e9-11e9-8cd9-0242ac1c000b)\"," + "\"personbUuid\":\"" + PatientLight.class.getName()
		        + "(ed279794-76e9-11e9-8cd9-0242ac1c000b)\"," + "\"relationshipTypeUuid\":\""
		        + RelationshipTypeLight.class.getName() + "(1)\"," + "\"startDate\":\"2019-05-28T13:42:31+00:00\","
